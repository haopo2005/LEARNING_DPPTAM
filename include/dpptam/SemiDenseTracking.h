...
class SemiDenseTracking  :public Imagenes {
  public:
    ...
    vector<cv::Mat> points_map_inImage;//'points_map_inImage' are the 3D points tracked that lie inside of the current image.
    ...
    vector<cv::Mat> points_map;//'points_map' are the 3D points tracked
